var Executor, ExecutorExec, ExecutorSpawn, charm, childProcess;
...
ExecutorExec = (function() {
  ...
  ExecutorExec.prototype.done = function(error, stdout, stderr) {
    ...
    if (!this.opts.stdoutcolor) {
      ...
      charm(process.stdout).push(true).foreground(this.opts.stdoutcolor).write(stdout).pop(true);
    }
    if (!this.opts.stderrcolor) {
      process.stderr.write(stderr);
    } else {
      charm(process.stderr).push(true).foreground(this.opts.stderrcolor).write(stderr).pop(true);
    }
...
ExecutorSpawn = (function() {
  ...
  ExecutorSpawn.prototype.stdout = function(data) {
    ...
    return charm(process.stdout).push(true).foreground(this.opts.stdoutcolor).write(data).pop(true);
  };
  ...
  ExecutorSpawn.prototype.stderr = function(data) {
    ...
    return charm(process.stderr).push(true).foreground(this.opts.stderrcolor).write(data).pop(true);
  };
