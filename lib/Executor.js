...
ExecutorExec = (function(_super) {
  ...
  ExecutorExec.prototype.done = function(error, stdout, stderr) {
    var secs;
    process.stdout.write(this.opts.colors.stdout(stdout));
    process.stderr.write(this.opts.colors.stderr(stderr));
...
ExecutorSpawn = (function(_super) {
  ...
  ExecutorSpawn.prototype.stdout = function(data) {
    return process.stdout.write(this.opts.colors.stdout(data));
  };

  ExecutorSpawn.prototype.stderr = function(data) {
    return process.stderr.write(this.opts.colors.stderr(data));
  };
